...
int mmu_tlb_init (tlb_type * tlb_t, int num);

void mmu_tlb_exit (tlb_type * tlb_t);

void mmu_tlb_invalidate_all (ARMul_State * state, tlb_type * tlb_t);

void
mmu_tlb_invalidate_entry (ARMul_State * state, tlb_type * tlb_t, ARMword addr);

tlb_entry_t *mmu_tlb_search (ARMul_State * state, tlb_type * tlb_t,
			     ARMword virt_addr);
