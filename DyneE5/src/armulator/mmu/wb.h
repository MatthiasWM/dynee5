 ...
 * 		 0:ok
 * */
int mmu_wb_init (wb_type * wb_t, int num, int nb);


/* wb_exit
 * @wb_t :wb_t to exit
 * */
void mmu_wb_exit (wb_type * wb);
 ...
 * */
void
mmu_wb_write_bytess (ARMul_State * state, wb_type * wb_t, ARMword pa,
		     ARMbyte * data, int n);
 ...
 * @wb_t wb_t to drain
 * */
void mmu_wb_drain_all (ARMul_State * state, wb_type * wb_t);
