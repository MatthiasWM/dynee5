 ...
 * */
int
mmu_wb_init (wb_type * wb_t, int num, int nb)
{
	int i;
 ...
 * */
void
mmu_wb_write_bytes (ARMul_State * state, wb_type * wb_t, ARMword pa,
		    ARMbyte * data, int n)
{
	int i;
	wb_entry_t *wb;
 ...
 * */
void
mmu_wb_drain_all (ARMul_State * state, wb_type * wb_t)
{
	ARMword pa;
	wb_entry_t *wb;
	int i;
