 ...
 */
int
mmu_cache_init (cache_type * cache_t, int width, int way, int set, int w_mode)
{
	int i, j;
	cache_set_t *sets;
	cache_line_t *lines;
...
void
mmu_cache_exit (cache_type * cache_t)
{
	int i, j;
 ...
 */
cache_line_t *
mmu_cache_search (ARMul_State * state, cache_type * cache_t, ARMword va)
{
	int i;
 ...
 */
cache_line_t *
mmu_cache_search_by_index (ARMul_State * state, cache_type * cache_t,
			   ARMword index)
{
	int way = cache_t->way;
 ...
 */
cache_line_t *
mmu_cache_alloc (ARMul_State * state, cache_type * cache_t, ARMword va,
		 ARMword pa)
{
	cache_line_t *cache;
	cache_set_t *set;
 ...
 */
void
mmu_cache_write_back (ARMul_State * state, cache_type * cache_t,
		      cache_line_t * cache)
{
	ARMword pa = cache->pa;
 ...
 */
void
mmu_cache_clean (ARMul_State * state, cache_type * cache_t, ARMword va)
{
	cache_line_t *cache;
 ...
 */
void
mmu_cache_clean_by_index (ARMul_State * state, cache_type * cache_t,
			  ARMword index)
{
	cache_line_t *cache;
 ...
 */
void
mmu_cache_invalidate (ARMul_State * state, cache_type * cache_t, ARMword va)
{
	cache_line_t *cache;
 ...
 */
void
mmu_cache_invalidate_by_index (ARMul_State * state, cache_type * cache_t,
			       ARMword index)
{
	cache_line_t *cache;
 ...
 * */
void
mmu_cache_invalidate_all (ARMul_State * state, cache_type * cache_t)
{
	int i, j;
	cache_set_t *set;
	cache_line_t *cache;
...
void
mmu_cache_soft_flush (ARMul_State * state, cache_type * cache_t, ARMword pa)
{
	ARMword set, way;
	cache_line_t *cache;
	pa = (pa / cache_t->width);
