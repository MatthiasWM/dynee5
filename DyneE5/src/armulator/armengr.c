...
static ARMsdword instr_current[256] = {
...
static ARMsdword pf_p_cyc, pf_p_energy;
...
{
	int opcode;
	ARMsdword ex_cycle, timing_cycle;
	ARMsdword mem_cycle, idle_cycle, uart_cycle, mem_idle_cycle;
	float ex_energy;
