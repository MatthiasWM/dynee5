...
# ADD CPP /nologo /MD /GX /Os /Ob2 /I "." /I ".." /I "..\..\..\Newt0\src\newt_core\incs" /I "..\..\..\Newt0\src\newt_core\incs\VC6" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "WIN32_LEAN_AND_MEAN" /D "VC_EXTRA_LEAN" /D "WIN32_EXTRA_LEAN" /YX /FD /c
...
# ADD LINK32 newtd.lib fltkd.lib fltkimagesd.lib fltkjpegd.lib wsock32.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"libcd" /out:"..\test\DyneTKd.exe" /pdbtype:sept /libpath:"..\lib" /libpath:"..\..\..\NEWT0\build"
